...
const toppings = [
    { id: '1', name: 'Chicken', image: '/pizza-margherita.png', price: 50, isAvailable: true },
    { id: '2', name: 'jelapeno', image: '/pizza-margherita.png', price: 50, isAvailable: true },
    { id: '3', name: 'Cheese', image: '/pizza-margherita.png', price: 50, isAvailable: true },
];
